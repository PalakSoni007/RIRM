...
@Component({
  selector: 'vex-enterprice-account',
  templateUrl: './enterprice-account.component.html',
  styleUrls: ['./enterprice-account.component.scss'],
...
export class EnterpriceAccountComponent implements OnInit {
